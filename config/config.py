...
from config.scanner import ScannerConfig
from config.logging import LoggingConfig
from config.captum import CaptumConfig
from config.optuna.optuna_config import StudyConfig, OptunaStudySpec
...
class Config(BaseModel):
    ...
    def _save_used_config(self):
        ...
        output_dir = Path(self.output_dir) / "configs"
