...
class PriceAcceleration1mFeature(BaseFeature):
    ...
    def __init__(self, config: Optional[FeatureConfig] = None):
        super().__init__(
            config or FeatureConfig(name="1m_price_acceleration", normalize=True)
        )
...
class PriceAcceleration5mFeature(BaseFeature):
    ...
    def __init__(self, config: Optional[FeatureConfig] = None):
        super().__init__(
            config or FeatureConfig(name="5m_price_acceleration", normalize=True)
        )
...
class VolumeAcceleration1mFeature(BaseFeature):
    ...
    def __init__(self, config: Optional[FeatureConfig] = None):
        super().__init__(
            config or FeatureConfig(name="1m_volume_acceleration", normalize=True)
        )
...
class VolumeAcceleration5mFeature(BaseFeature):
    ...
    def __init__(self, config: Optional[FeatureConfig] = None):
        super().__init__(
            config or FeatureConfig(name="5m_volume_acceleration", normalize=True)
        )
        self.normalizer = MinMaxNormalizer(min_val=-5.0, max_val=5.0)
