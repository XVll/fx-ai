...
from v2.simulators.portfolio_simulator import PortfolioState, FillDetails
...
class RewardAggregator:
    ...
    def calculate_total_reward(
        ...
        for component in self.components:
            ...
            self.component_stats[comp_name]["min"] = min(
                self.component_stats[comp_name]["min"], reward
            )
            self.component_stats[comp_name]["max"] = max(
                self.component_stats[comp_name]["max"], reward
            )
